function [qrcod, qmask] = qrmodule( ver , btst , alnvec , ecc)
% Draw Qr Code
...
qmask(1:7,1:7) = 1;                 % top left corner
qmask(qrs-6:qrs,1:7) = 1;           % bottom left corner
qmask(1:7,qrs-6:qrs) = 1;           % top right corner

%% Add Seperators
%%
qrcod(8,1:7)             = 1;           qrcod(1:8,8)            = 1;
qrcod(8,qrs-6:qrs)       = 1;           qrcod(1:8,qrs-7)        = 1;
qrcod(qrs-7,1:7)         = 1;           qrcod(qrs-7:qrs,8)      = 1;

qmask(8,1:7)             = 1;           qmask(1:8,8)            = 1;
qmask(8,qrs-6:qrs)       = 1;           qmask(1:8,qrs-7)        = 1;
qmask(qrs-7,1:7)         = 1;           qmask(qrs-7:qrs,8)      = 1;
